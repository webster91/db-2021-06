...
CREATE INDEX idx_user_gender_id ON entity."user" (genderId);
CREATE INDEX idx_user_roles_ids ON entity."user" (rolesIds);
CREATE INDEX idx_user_telephone ON entity."user" (telephone);
...
CREATE INDEX idx_meter_type_id ON entity.Meter (typeId);
